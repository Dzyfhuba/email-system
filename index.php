...
<body class="bg-dark">
    <div class="accordion" id="accordionExample">
        <form id="data" method="POST" action="javascript:void(0);">
            ...
            <div>
                <button id="save" type="submit" class="btn btn-primary w-100" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Save</button>
            </div>
        </form>
    </div>
